...
ActiveRecord::Schema.define(version: 20170814060108) do
  ...
  create_table "carts", force: :cascade do |t|
    ...
    t.integer  "additional_miles_price_per_mile_cents", limit: 4
    t.integer  "generator_hours_price_per_hour_cents",  limit: 4
    t.integer  "cleaning_fee_cents",                    limit: 4
    t.integer  "housekeeping_kit_price_cents",          limit: 4
    t.integer  "dump_water_fee_cents",                  limit: 4
    t.integer  "security_deposit_cents",                limit: 4
    t.string   "delivery_fee_per_mile",                 limit: 255
    t.string   "cancellation_policy",                   limit: 255
    t.integer  "minimum_duration",                      limit: 4
    t.integer  "additional_miles",                      limit: 4
    t.integer  "additional_generator_hours",            limit: 4
    t.integer  "pickup_dropoff_fee_cents",              limit: 4
    t.integer  "included_miles_per_day",                limit: 4
    t.integer  "included_generator_hours_per_day",      limit: 4
  ...
  create_table "community_memberships", force: :cascade do |t|
    ...
    t.integer  "commission_percent",  limit: 4,   default: 100
    t.boolean  "is_owner",                        default: false
    t.boolean  "allow_inquiry",                   default: false
  end
  ...
  create_table "other_fees", force: :cascade do |t|
  ...
  add_index "other_fees", ["cart_id"], name: "index_other_fees_on_cart_id", using: :btree
  ...
  create_table "payment_gateways", force: :cascade do |t|
    ...
    t.datetime "created_at",                                         null: false
    t.datetime "updated_at",                                         null: false
    t.string   "stripe_api_key",                       limit: 255
  ...
  create_table "payment_splits", force: :cascade do |t|
    t.integer  "payment_id",               limit: 4
    t.string   "status",                   limit: 255
    t.integer  "sum_cents",                limit: 4
    t.integer  "commission_cents",         limit: 4
    t.string   "currency",                 limit: 255
    ...
    t.integer  "refund_cents",             limit: 4
    t.datetime "paid_at"
  end

  add_index "payment_splits", ["due_on"], name: "index_payment_splits_on_due_on", using: :btree
  add_index "payment_splits", ["paid_on"], name: "index_payment_splits_on_paid_on", using: :btree
  add_index "payment_splits", ["payment_id"], name: "index_payment_splits_on_payment_id", using: :btree
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.integer  "commission_cents",         limit: 4
    t.string   "stripe_transaction_id",    limit: 255
    t.integer  "adjusted_sum_cents",       limit: 4
    t.integer  "commission_percent",       limit: 4
  end
  ...
  create_table "stripe_accounts", force: :cascade do |t|
    ...
    t.string   "stripe_source_info",     limit: 255
  end

  add_index "stripe_accounts", ["community_id"], name: "index_stripe_accounts_on_community_id", using: :btree
  add_index "stripe_accounts", ["person_id"], name: "index_stripe_accounts_on_person_id", using: :btree
  add_index "stripe_accounts", ["stripe_user_id"], name: "index_stripe_accounts_on_stripe_user_id", using: :btree
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.string   "payment_status",                    limit: 255, default: "not_paid"
    t.integer  "commission_from_seller",            limit: 4
  ...
  add_foreign_key "payment_splits", "payments"
end
