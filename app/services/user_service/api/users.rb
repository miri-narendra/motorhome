module UserService::API
  module Users
    DEFAULT_COMMISSION_FROM_SELLER = 100
    ...
    def create_user(user_hash, community_id, invitation_id = nil)
      ...
      begin
        ...
        person = Person.new(
          ...
          commission_percent: (community.present? ? community.commission_from_seller : DEFAULT_COMMISSION_FROM_SELLER),
		  is_owner_extra:user_hash[:is_owner_extra])
